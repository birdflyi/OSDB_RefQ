...
REPOSITORY_AUDIT_HEAD = 837f61791adbe96a9565a2cc4fe1a6e377fa5662
```
...
MS_R05_PROMOTION_COMMIT = 837f61791adbe96a9565a2cc4fe1a6e377fa5662
```
...
EN_R03_A04_GATE = CH5_REFQ_STYLE_A04_PASS_WITH_METADATA_REPAIR_ONLY
EN_R03_PROMOTION_STATUS = SEMANTICALLY_ACCEPTED
EN_R03_PROMOTION_COMMIT = dbc282401fb8450f7a2ff6f5958e2f7e612a3a3f
EN_R03_PROMOTION_METADATA_STATUS = CLOSED
```

EN-R03 is the accepted English semantic source derived from MS-R05; it does
not replace the Chinese semantic/scientific authority. JSS-specific packaging
and submission transformations remain downstream.
