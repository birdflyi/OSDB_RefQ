...
from .paths import HISTORICAL_P0_ROOT, HISTORICAL_SUPPLEMENTAL_ROOT, REPOSITORY_ROOT, canonical_path
...
def build_historical_immutability_baseline(
    *,
    ...
    payload = {
        "schema_version": "ch5_refq_c3_7f_historical_immutability_baseline_v1",
...
def load_historical_baseline(path: str | Path = DEFAULT_BASELINE_PATH) -> dict[str, Any]:
    ...
    if not isinstance(value, dict) or value.get("schema_version") != "ch5_refq_c3_7f_historical_immutability_baseline_v1":
