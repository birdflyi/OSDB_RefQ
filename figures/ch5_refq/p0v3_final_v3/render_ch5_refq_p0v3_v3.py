...
matplotlib.rcParams.update(
    {
        "svg.hashsalt": "ch5-refq-p0v3-final-v3",
        "svg.fonttype": "none",
...
def save_figure(fig, out_dir: Path, figure_id: str):
    ...
    fig.savefig(
        pdf,
        format="pdf",
        metadata={"Creator": "ch5-refq-p0v3-final-v3", "Producer": "matplotlib", "CreationDate": None, "ModDate": None},
        bbox_inches="tight",
        pad_inches=0.08,
    )
    fig.savefig(png, format="png", dpi=300, metadata={"Software": "ch5-refq-p0v3-final-v3"}, bbox_inches="tight", pad_inches=0.08)
    plt.close(fig)
...
def make_contact_sheet(output_root: Path):
    ...
    fig.savefig(contact_path, format="png", dpi=200, metadata={"Software": "ch5-refq-p0v3-final-v3"}, bbox_inches="tight", pad_inches=0.08)
    plt.close(fig)
...
def render_all(output_root: Path):
    ...
    render_manifest = {
        "render_set_version": "ch5-refq-p0v3-final-v3", "parent_repository_HEAD": os.environ.get("CH5_REFQ_PARENT_HEAD", "c067750cadea3c18342fe2d97ebdb972b149d345"),
